...
const nyoutube = ('©YonnBot‡')  //ubah di config biar ngk emro
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup YonnBot: https://chat.whatsapp.com/JmkBrl0l6NI37pQBdRfa6M\nNOTE : Kalo kakak nya Punya Bot Masukin aja\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
                m.reply('THANK TO :\nYonn: https://github.com/AYYONNIH')
            }
            break
            case 'chat': {
...
didin.send5ButImg(i, txt, `YonnBot`, log0, btn, thum)
}
...
if (!isCreator) return replay(mess.owner)
            ...
            didin.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer: `YonnBot`, mentions: [m.sender] })
		}		
            }
            break
            case 'q': case 'quoted': {
...
"pollCreationMessage": {
"name": "*_Halo Kk, Saya Owner YonnBot*\n\n*_Apakah Kk Nya Puas Dengan Fitur Fitur Yang Ada Di YonnBot ?_*",
"options": [
	{
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `62895606093746@s.whatsapp.net`
let dana = `62895606093746@s.whatsapp.net`
let shopeeotp = `62895606093746@s.whatsapp.net`
let shopee = `62895606093746@s.whatsapp.net`
let tokopedia = `62895606093746@s.whatsapp.net`
let smartfrend = `62895606093746@s.whatsapp.net`
let getcontact = `62895606093746@s.whatsapp.net`
let facebook = `62895606093746@s.whatsapp.net`
let pasarpolis = `62895606093746@s.whatsapp.net`
let kominfo = `62895606093746@s.whatsapp.net`
let alfamart = `62895606093746@s.whatsapp.net`
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
...
case 'store':{
  ...
  const listMessage = {
   text: `*_Welcome To YonnBot Store_*`,
   footer: "YonnBot",
   title: "",
...
ɴᴏᴛᴇ : ʙᴏᴛ ɪɴɪ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴀᴜᴛᴏʀᴇᴀᴅ ᴀᴛᴀᴜ ʟᴀɴɢsᴜɴɢ ᴍᴇᴍʙᴀᴄᴀ ᴘᴇsᴀɴ ʏᴀɴɢ ᴘᴇɴɢɢᴜɴᴀ ᴋɪʀɪᴍ.`
    var button = [{ buttonId: `sewabot`, buttonText: { displayText: `FOLLOW IG‡` }, type: 1 }, { buttonId: `DONASI`, buttonText: { displayText: `DONASI‡` }, type: 1 }]
...
case 'tesrow':{
	...
	rows: [
	   {
	    ...
	    description: " Bantu Follow medsos Owner ",
	    },	    
     ]
    },
    {
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku YonnBot Bot whatsapp multi-device yang dapat membantumu_`,
   footer: "YonnBot",
   title: "",
...
case 'gamemenu':{
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Berikut Game" Yang Tersedia Di YonnBot_`,
   footer: "YonnBot",
   title: "",
   buttonText: "Buka!",
   sections
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*❏ YonnBot*
...
ORI : https://github.com/AYYONNIH/yonnclf
© YonnBot`, ' ', ' ', `Buka!`, sections, m)
       }
break
...
- Dana : 62895606093746
- OVO : 62895606093746
- Saweria : https://saweria.co/YonnXD
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*────── 「 MEDSOS OWN 」 ──────*
                
• GITHUB : https://github.com/AYYONNIH
• INSTAGRAM : https://instagram.com/yonnxdjr
┗━━━•❅•°•❈`, ' ', ' ', `Lihat!`, sections, m)
       }
break
            case 'grupmenu': {
